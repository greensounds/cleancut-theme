    	...
    	<div class="container">
    		<div class="col-md-12">
    			<div class="showcase-content">
    				...
    				<p class="lead">
    					<?php echo get_theme_mod('showcase_heading', 'Theme realizado por GreenSounds')?>
    				</p>
                    <?php if(get_theme_mod('facebook_url', 'https://www.facebook.com/') != '') : ?>
    				<a class="btn  btn-default  btn-lg"><i class="fa fa-facebook fa-fw" href="<?php echo get_theme_mod('facebook_url', 'https://www.facebook.com/'); ?>" target="_blank"></i>Facebook</a>
                    <?php endif;?>
    				<?php if(get_theme_mod('facebook_url', 'https://www.linkedin.com/') != '') :?>
                    <a class="btn  btn-default  btn-lg"><i class="fa fa-linkedin fa-fw" href="<?php echo get_theme_mod('linkedin_url', 'https://www.linkedin.com/'); ?>" target="_blank"></i>Linkedin</a>
                    <?php endif;?>
                    <?php if(get_theme_mod('twitter_url', 'https://www.twitter.com/') != '') :?>
                    <a class="btn  btn-default  btn-lg"><i class="fa fa-twitter fa-fw" href="<?php echo get_theme_mod('twitter_url', 'https://www.twitter.com/'); ?>" target="_blank"></i>Twitter</a>
                    <?php endif;?>
    			</div>
    		</div>
    	</div>
